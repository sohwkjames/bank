...
org.opentest4j.AssertionFailedError: expected: <Interest rules:
| Date | RuleId | Rate(%) |
| 20250101 | R3 | 3.30 |
| 20250102 | R2 | 1.20 |
> but was: <Interest rules:
| Date | RuleId | Rate (%) |
| 20250101 | R3 | 3.30 |
| 20250102 | R2 | 1.20 |
>
	...
	at com.example.bank.InterestRuleServiceTest.testGenerateStatement(InterestRuleServiceTest.java:57)
